...
//         bool IIsMoveLegal.IsMoveLegal(){
//             if (Participant.Player().hand.HandValue() !> 21 && Participant.Player().hand.HandValue() == 9 || Participant.Player().hand.HandValue() == 10 || Participant.Player().hand.HandValue() == 11 && Participant.Player().chipStack.chipStack > Participant.Player().chipStack.bet)
//             {
//                 return true;
//             }
//             else
...
//     //             GameOrder.players[GameOrder.players.Count - 1].Hand.AddCard(Deck.DrawCard());
